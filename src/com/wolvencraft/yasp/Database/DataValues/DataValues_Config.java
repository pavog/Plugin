...
public enum DataValues_Config implements IDataValues {
	...
	public static void refresh() {
		List<Map<String, String>> results = DBSynchDataGetSet.getValues(DataStores.CONFIGURATION, DataValues_Config.DATABASE_VERSION, Integer.toString(StatsPlugin.getSettings().DB_VERSION));
