...
import com.wolvencraft.yasp.db.data.items.ItemsDetailedStats.ItemConsumeEntry;
import com.wolvencraft.yasp.db.data.items.ItemsDetailedStats.ItemDropEntry;
import com.wolvencraft.yasp.db.data.items.ItemsDetailedStats.ItemPickupEntry;
...
public class ItemsDataStore extends DataStore<ItemsTotalStats, DetailedData> {
    ...
    public ItemsTotalStats getNormalData(ItemStack itemStack) {
        ...
        ItemsTotalStats entry = new ItemsTotalStats(getSession().getId(), itemStack);
