...
package com.mctrakr.modules.data.hooks.pvparena;
...
import com.mctrakr.modules.data.hooks.pvparena.Tables.PvpArenaTable;
...
public class PvpArenaPlayerStats extends NormalData {
    ...
    public void fetchData() {
        if(Query.table(PvpArenaTable.TableName)
                .condition(PvpArenaTable.PlayerId, session.getId())
                .exists()) return;
        ...
        Query.table(PvpArenaTable.TableName)
            .value(PvpArenaTable.PlayerId, session.getId())
