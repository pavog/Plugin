...
package com.mctrakr.modules.data.hooks.factions;
...
import com.mctrakr.modules.data.hooks.factions.Tables.FactionsTable;
...
public class FactionsPlayerStats extends NormalData {
    ...
    public void fetchData() {
        if(Query.table(FactionsTable.TableName)
                .condition(FactionsTable.PlayerId, session.getId())
                .exists()) return;
        ...
        Query.table(FactionsTable.TableName)
            .value(FactionsTable.PlayerId, session.getId())
