...
package com.mctrakr.modules.data.hooks.banhammer;
...
public class BanHammerHook extends PluginHook {
    ...
    private static final String PLUGIN_NAME = "BanHammer";
    
    private BanHammer instance;
    
    public BanHammerHook() {
        super(BanHammerDataStore.lock, PLUGIN_NAME);
    }
