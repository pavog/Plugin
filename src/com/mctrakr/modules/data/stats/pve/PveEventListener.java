...
import com.mctrakr.modules.data.stats.pve.PveEventHandler.MonsterDeath;
import com.mctrakr.modules.data.stats.pve.PveEventHandler.PlayerPveDeath;
import com.mctrakr.managers.HandlerManager;
import com.mctrakr.settings.Constants.StatPerms;

public class PveEventListener implements Listener {
    ...
    public void onPlayerDeath(PlayerDeathEvent event) {
        ...
        if(!HandlerManager.playerLookup(player, StatPerms.DeathPVE)) return;
        ...
        HandlerManager.runAsyncTask(new PlayerPveDeath(player, ((EntityDamageByEntityEvent) lastDamageEvent)));
    }
