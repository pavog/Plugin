...
import com.mctrakr.modules.data.stats.pve.PveDetailedStats.PVEEntry;
...
public class PveDataStore extends LargeDataStore<PveTotalStats, PVEEntry> {
    ...
    public static ConfigLock lock = new ConfigLock(PrimaryType.PVE);
    
    public PveDataStore(OnlineSession session) {
        super(session, PrimaryType.PVE);
    }
    ...
    public PveTotalStats getNormalData(EntityType type, ItemStack weapon) {
        ...
        PveTotalStats entry = new PveTotalStats(session, type, weapon);
    ...
    public void playerKilledCreature(Entity victim, ItemStack weapon) {
        ...
        PVEEntry detailedEntry = new PVEEntry(session, victim.getType(), victim.getLocation(), weapon);
    ...
    public void creatureKilledPlayer(Entity killer, ItemStack weapon) {
        ...
        PVEEntry detailedEntry = new PVEEntry(session, killer.getType(), killer.getLocation());
        addDetailedDataEntry(detailedEntry);
