...
package com.mctrakr.modules.data.stats.player;

import org.bukkit.Location;

import com.mctrakr.modules.data.SmallDataStore;
import com.mctrakr.modules.data.stats.player.PlayerDetailedStats.PlayerLogin;
import com.mctrakr.modules.data.stats.player.PlayerTotalStats.BasicPlayerStats;
...
public class PlayerDataStore extends SmallDataStore<BasicPlayerStats, PlayerLogin> {
    ...
    public PlayerDataStore(OnlineSession session) {
        ...
        setNormalData(new BasicPlayerStats(session));
    }
    ...
    public void addPlayerLog(Location location, boolean isLogin) {
        addDetailedDataEntry(new PlayerLogin(session, location, isLogin));
    }
