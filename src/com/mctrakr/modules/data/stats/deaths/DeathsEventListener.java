...
import com.mctrakr.modules.data.stats.deaths.DeathsEventHandler.PlayerNaturalDeath;
 ...
 *
 */
public class DeathsEventListener implements Listener {
    
    public DeathsEventListener() {
    ...
    public void onPlayerDeath(PlayerDeathEvent event) {
        ...
        HandlerManager.runAsyncTask(new PlayerNaturalDeath(player, lastDamageEvent));
    }
}
