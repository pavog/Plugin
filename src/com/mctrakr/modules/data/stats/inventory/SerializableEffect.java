...
public class SerializableEffect {
    ...
    private SerializableEffect(PotionEffect effect) {
    ...
    public static String serialize(Collection<PotionEffect> effects) {
        List<SerializableEffect> potEffects = new ArrayList<SerializableEffect>();
        for(PotionEffect eff : effects) {
            try { potEffects.add(new SerializableEffect(eff)); }
            catch (Throwable t) {
