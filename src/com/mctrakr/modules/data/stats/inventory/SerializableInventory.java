...
public class SerializableInventory {
     ...
     */
    private SerializableInventory(ItemStack stack) {
        ...
        enchantments = SerializableEnchantment.serialize(stack.getEnchantments());
    }
    ...
    public static String serialize(List<ItemStack> inventoryRow) {
        List<SerializableInventory> invRow = new ArrayList<SerializableInventory>();
        for(ItemStack stack : inventoryRow) {
            try {
                if(stack == null) { stack = new ItemStack(Material.AIR); }
                invRow.add(new SerializableInventory(stack));
            } catch (Throwable t) {
