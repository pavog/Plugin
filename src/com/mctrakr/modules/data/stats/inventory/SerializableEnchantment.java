...
package com.mctrakr.modules.data.stats.inventory;
...
public class SerializableEnchantment {
     ...
     */
    private SerializableEnchantment(Enchantment enchantment, int level) {
     ...
     * @return Json array
     */
    public static List<SerializableEnchantment> serialize(Map<Enchantment, Integer> enchantments) {
        List<SerializableEnchantment> enchList = new ArrayList<SerializableEnchantment>();
        ...
        while (it.hasNext()) {
            try {
                ...
                enchList.add(new SerializableEnchantment(enchantment.getKey(), enchantment.getValue().intValue()));
            } catch (Throwable t) {
