...
package com.mctrakr.modules.data.stats.server;
 ...
 *
 */
public class ServerStatistics implements Module {
    
    private static ConfigLock lock = new ConfigLock(PrimaryType.Server);
    ...
    public boolean pushData() {
        if(!lock.isEnabled()) return false;
