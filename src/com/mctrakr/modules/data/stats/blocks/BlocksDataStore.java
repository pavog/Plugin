...
import com.mctrakr.modules.data.stats.blocks.BlocksDetailedStats.BlockBreakEntry;
import com.mctrakr.modules.data.stats.blocks.BlocksDetailedStats.BlockPlaceEntry;
...
public class BlocksDataStore extends LargeDataStore<BlocksTotalStats, DetailedData> {
    ...
    public void blockBreak(BlockState block) {
        ...
        BlockBreakEntry detailedEntry = new BlockBreakEntry(session, block);
    ...
    public void blockPlace(BlockState block) {
        ...
        BlockPlaceEntry detailedEntry = new BlockPlaceEntry(session, block);
        addDetailedDataEntry(detailedEntry);
