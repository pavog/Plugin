...
public class MiscStats extends NormalData {
     ...
     */
    public MiscStats(OnlineSession session) {
        super(session);
    ...
    public void fetchData() {
        QueryResult result = Query.table(MiscInfoTable.TableName)
            .condition(MiscInfoTable.PlayerId, session.getId())
            .select();
        if(result == null) {
            Query.table(MiscInfoTable.TableName)
                .value(MiscInfoTable.PlayerId, session.getId())
                .valueRaw(values)
                .insert();
        } else {
    ...
    public void killed(Player player) {
        ...
        MiscDataStore misc = ((MiscDataStore) victim.getDataStore(PrimaryType.Misc));
