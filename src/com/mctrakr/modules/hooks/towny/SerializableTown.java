...
package com.mctrakr.modules.hooks.towny;

import com.mctrakr.Statistics;
import com.palmergames.bukkit.towny.object.Town;

@SuppressWarnings("unused")
public class SerializableTown {
    ...
    private SerializableTown(Town town) {
        name = town.getName();
        tag = town.getTag();
    ...
    public static String serialize(Town town) {
        return Statistics.getGson().toJson(new SerializableTown(town));
    }
