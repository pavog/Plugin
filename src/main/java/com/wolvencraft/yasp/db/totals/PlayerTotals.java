...
public class PlayerTotals {
    ...
    public void fetchData() {
        ...
        try {
            values.put(PlayerVariable.SESSION_START, Query.table(PlayerStats.TableName).column(PlayerStats.LoginTime).condition(PlayerStats.PlayerId, playerId).select().asLong(PlayerStats.LoginTime));
