...
?>
	...
	<dl class="dl-horizontal">
		<dt style="width: 110px !important;"><span class="badge badge-success"><?php echo "<img src='../data/util/block/?name=".$mostPlacedName."' style='width:15px; height:15px;' alt='".$mostPlaced."' title='".$mostPlacedNum." times' /> ".$mostPlacedNum; ?></span></dt>
	...
	<dl class="dl-horizontal">
		<dt style="width: 110px !important;"><span class="badge badge-important"><?php echo "<img src='../data/util/block/?name=".$mostDestroyedName."' style='width:15px; height:15px;' alt='".$mostDestroyed."' title='".$mostDestroyedNum." times' /> ".$mostDestroyedNum; ?></span></dt>
