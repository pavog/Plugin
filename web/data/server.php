...
<div class="row-fluid">
	...
	<div class="span4">
		...
		<?php include ("./data/server_blocks.php"); ?>
		</div>
		...
		<?php include ("./data/server_items.php"); ?>
		</div>
	</div>
	...
	<div class="span8">
		...
		<?php include ("./data/server_players.php"); ?>
		</div>
		...
		<div style="height: 170px;"><?php include ("./data/server_kills.php"); ?></div>
		</div>
	</div>
