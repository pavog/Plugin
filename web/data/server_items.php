...
?>
	...
	<dl class="dl-horizontal">
		<dt style="width: 110px !important;"><span class="badge badge-success"><?php echo "<img src='../data/util/block/?name=".$mostPickedUpName."' style='width:15px; height:15px;' alt='".$mostPickedUp."' title='".$mostPickedUpNum." times' /> ".$mostPickedUpNum; ?></span></dt>
	...
	<dl class="dl-horizontal">
		<dt style="width: 110px !important;"><span class="badge badge-important"><?php echo "<img src='../data/util/block/?name=".$mostDroppedName."' style='width:15px; height:15px;' alt='".$mostDropped."' title='".$mostDroppedNum." times' /> ".$mostDroppedNum; ?></span></dt>
