...
<div class="fluid-row">
	<div class="span6">
		<dl class="dl-horizontal">
			<dt style="width: 60px !important;"><span class="badge badge-success" style="padding: 10px 15px;"><?php echo "<img src='../data/util/block/?name=".$weaponMostDangerousImg."' style='width:20px;height:20px;' title='".$weaponMostDangerous."' alt='".$weaponMostDangerous."' />"; ?></span></dt>
	...
	<div class="span6">
		...
		<dl class="dl-horizontal">
			<dt style="width: 60px !important;"><span class="badge badge-success" style="padding: 10px 15px;"><?php echo $totalPVPKills; ?></span></dt>
			<dd style="margin-left: 80px !important;">PvP Kills</dd>
		</dl>
		<dl class="dl-horizontal">
		...
		<dl class="dl-horizontal">
			...
			<dd style="margin-left: 80px !important;">Most Deaths</dd>
		</dl>
